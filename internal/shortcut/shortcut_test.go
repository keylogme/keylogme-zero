...
func TestGetNewShortcutDetector(t *testing.T) {
	sgs := []types.ShortcutGroupInput{
		{
			Id: "1", Name: "test1", Shortcuts: []types.ShortcutCodes{
				{
					Id:    "1",
					Name:  "dummy1",
					Codes: []uint16{1, 2, 3},
					Type:  types.SequentialShortcutType,
				},
				{
					Id:    "2",
					Name:  "dummy2",
		...
		{
			Id: "2", Name: "test2", Shortcuts: []types.ShortcutCodes{
				{Id: "3", Name: "dummy3", Codes: []uint16{10, 11}, Type: types.HoldShortcutType},
			},
		},
	}
...
func TestDuplicateShortcutGroupIds(t *testing.T) {
	sgs := []types.ShortcutGroupInput{
		...
		{
			Id: "1", Name: "test2", Shortcuts: []types.ShortcutCodes{
				{Id: "3", Name: "dummy3", Codes: []uint16{10, 11}, Type: types.HoldShortcutType},
			},
		},
	}
...
func TestDuplicateShortcutIds(t *testing.T) {
	sgs := []types.ShortcutGroupInput{
		...
		{
			Id: "2", Name: "test2", Shortcuts: []types.ShortcutCodes{
				{Id: "1", Name: "dummy3", Codes: []uint16{10, 11}, Type: types.HoldShortcutType},
			},
		},
	}
	_, err := getShortcutsFromGroups(sgs)
